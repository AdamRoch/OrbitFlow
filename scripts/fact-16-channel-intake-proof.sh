...
container_name="orbitfactory-fact16-postgres-proof"
database_name="orbitfactory_fact16_proof"
database_user="orbitfactory"
database_password="fact16-local-proof"
...
export ORBITFACTORY_FACT16_PROOF_DATABASE="$database_name"
npm run test:channel-intake

echo "FACT-16 channel intake proof passed"
