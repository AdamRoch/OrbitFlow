...
container_name="orbitfactory-fact23-postgres-proof"
database_name="orbitfactory_fact23_proof"
database_user="orbitfactory"
database_password="fact23-local-proof"
...
export ORBITFACTORY_FACT23_PROOF_DATABASE="$database_name"
node --experimental-strip-types --test test/postgres/guardrails.test.mjs
