...
container_name="orbitfactory-fact47-postgres-proof-$$"
database_name="orbitfactory_fact47_proof"
database_user="orbitfactory"
database_password="fact47-local-proof"
...
export ORBITFACTORY_FACT47_PROOF_DATABASE="$database_name"

node --experimental-strip-types --test test/postgres/fact-47-indeterminate-recovery.test.mjs
