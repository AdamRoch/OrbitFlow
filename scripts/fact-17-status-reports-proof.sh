...
container_name="orbitfactory-fact17-postgres-proof"
database_name="orbitfactory_fact17_proof"
database_user="orbitfactory"
database_password="fact17-local-proof"
...
export ORBITFACTORY_FACT17_PROOF_DATABASE="$database_name"
npm run test:channel-status-reports

echo "FACT-17 status reports proof passed"
