...
container_name="orbitfactory-fact10-postgres-proof"
database_name="orbitfactory_fact10_proof"
database_user="orbitfactory"
database_password="fact10-local-proof"
...
export ORBITFACTORY_FACT10_PROOF_DATABASE="$database_name"
