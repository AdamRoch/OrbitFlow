...
container_name="orbitflow-fact26-postgres-proof"
database_name="orbitflow_fact26_proof"
database_user="orbitflow"
database_password="fact26-local-proof"
...
export ORBITFLOW_FACT26_PROOF_DATABASE="$database_name"

# Every provider boundary is fake. Credential absence is an assertion inside the suite.
env -u OPENROUTER_API_KEY -u TELEGRAM_BOT_TOKEN \
  ./node_modules/.bin/tsx --test test/postgres/critical-paths.test.ts
