...
container_name="orbitfactory-fact37-postgres-proof"
database_name="orbitfactory_fact37_proof"
database_user="orbitfactory"
database_password="fact37-local-proof"
...
echo "FACT-37 Telegram clarification proof passed"
