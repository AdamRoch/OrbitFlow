...
container_name="orbitfactory-fact9-postgres-proof"
database_name="orbitfactory_fact9_proof"
database_user="orbitfactory"
database_password="fact9-local-proof"
...
export ORBITFACTORY_FACT9_PROOF_DATABASE="$database_name"

npm run test:message-bus
